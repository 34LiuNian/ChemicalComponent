 ...
 * @property {boolean}       [disableOverlay] - 禁用原子标签覆盖层（配合 fontFile 使用原生 FreeType 字体），默认 false
 */
...
export async function renderMolecule(containerId, smiles, options = {}) {
  ...
  try {
    ...
    // 原子标签覆盖（可禁用：fontFile 模式下原生字体已生效）
    const svgEl = container.querySelector('svg');
    if (svgEl && !opts.disableOverlay) {
...
export { setRdkitCdn, loadCustomRdkit, resetRdkit } from './rdkit-loader.js';
